...
Wszystkie podpunkty zostały zrealizowane za pomocą jednego pliku Dockerfile. Obraz bazuje na systemie Ubuntu 24.04. Java, Kotlin oraz Gradle zostały zainstalowane za pomocą menedżera pakietów SDKMAN. W pliku Docker Compose znajdują się dwa identyczne serwisy, z których jeden jest budowany bezpośrednio z Dockerfile, a drugi pobierany z Docker Hub.
