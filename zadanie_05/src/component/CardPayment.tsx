    ...
    <div className="flex flex-col w-full items-center py-8 justify-around">
      <div className="flex">
        <div className="flex flex-col w-1/2 items-center">
          <p>Imię</p>
          <input className="border-1 w-2/3" value={cardDetails.firstname} onChange={updateFirstName}/>
        </div>
        <div className="flex flex-col w-1/2 items-center">
          <p>Nazwisko</p>
          <input className="border-1 w-2/3" value={cardDetails.lastname} onChange={updateLastName}/>
        </div>
      </div>
      <div className="flex flex-col py-4 w-full">
        <p className="text-center">Podaj numer karty</p>
        <div className="flex justify-around">
          <input className="border-1 w-1/2 text-center" placeholder="xxxx-xxxx-xxxx-xxxx" value={cardDetails.cardNumber} onChange={updateCardNumber}/>
        </div>
      </div>
      <div className="flex">
        <div className="flex flex-col w-1/2 items-center">
          <p>Data ważności</p>
          <input className="border-1 w-2/3 text-center" placeholder="MM/YY" value={cardDetails.expireTime} onChange={updateExpireTime}/>
        </div>
        <div className="flex flex-col w-1/2 items-center">
          <p>Kod CVV</p>
          <input className="border-1 w-2/3 text-center" placeholder="XXX" value={cardDetails.cvv} onChange={updateCVV}/>
        </div>
      </div>
    </div>
  )
